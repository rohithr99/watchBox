...
const View = () => {
    ...
    return (
        <section>
            <div className="bg-red-100 py-8 min-h-screen flex justiffy-center items-center">
                    ...
                    <div className="flex flex-col md:flex-row -mx-4">
                        <div className="md:flex-1 px-4">
                            ...
                            <div className="flex -mx-2 mb-4">
                                ...
                                <div className="w-1/2 px-2">
                                    <button className="w-full bg-gray-400 text-gray-800 py-2 px-4 rounded-full font-bold hover:bg-gray-300">Already Watched</button>
                                </div>
                            </div>
                        </div>
                        <div className="md:flex-1 px-4">
